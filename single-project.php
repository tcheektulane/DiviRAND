			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! $is_page_builder_used ) : ?>
					...
					<div class="et_main_title">
						...
						<p><strong>Part of the <a href="/project/">Human Impacts Research Database</a></strong></p>
					</div>
...
<!-- begin Monica's edits -->

<h3>Project Data</h3>
<?php the_meta(); ?>  <!-- Monica added this line to display meta data --> 

<p><span class="et_project_categories"><strong>Focus Area(s):</strong> <?php echo get_the_term_list( get_the_ID(), 'project_category', '', ', ' ); ?></span></p>
<p><span class="et_project_categories"><strong>State(s):</strong> <?php echo get_the_term_list( get_the_ID(), 'project_tag', '', ', ' ); ?></span></p>
